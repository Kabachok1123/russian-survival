...
public final class ModItems {
    ...
    public static final Item BEAR_BELL = register("bear_bell", new BlockItem(ModBlocks.BEAR_BELL, new Item.Properties().stacksTo(16)));
    ...
    public static void initialize() {
        ...
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.COMBAT).register(entries -> entries.accept(USHANKA));
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.FUNCTIONAL_BLOCKS).register(entries -> { entries.accept(SAMOVAR); entries.accept(BEAR_BELL); });
